...
def generate_print_friendly_html(date: str, schedule: Dict[str, List[str]], down_stations_data: Dict[str, List[int]]) -> str:
    ...
    css_styles = f"""
        <style>
            ...
            /* --- NEW WATERMARK STYLES (SVG TILE METHOD) --- */
            .full-page-watermark {{
                position: fixed; 
                top: 0;
                left: 0;
                ...
                background-repeat: repeat; /* This tiles it infinitely */
            }}
        </style>
    """
    ...
    <body>
        <!-- NEW Watermark: This single div holds the repeating background -->
        <div class='full-page-watermark'></div>

        <!-- Your existing content container (sits on top) -->
        <div class='container'>
...
def main() -> None:
    ...
    if 'last_date' in st.session_state and st.session_state.last_date != current_date_str_for_display:
        ...
        # The current initialize_sstate_state logic is designed to clear on new day.
        st.info(
